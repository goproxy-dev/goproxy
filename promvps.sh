...
start() {
    ...
    cd ${DIRECTORY}
    cat <<EOF >promvps-watchdog
#!/bin/sh
# Generated by promvps.sh
until $(pwd)/promvps -log_dir . ; do
    sleep 1
done
EOF
    chmod +x promvps-watchdog
    nohup ${DIRECTORY}/promvps-watchdog >/dev/null 2<&1 &
    local pid=$!
